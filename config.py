...
class Config:
    ...
    ##############################################
    #              إضافة قيمة وهمية لـ SITE_URL   #
    ##############################################

    SITE_URL = os.getenv("SITE_URL", "http://localhost")  # قيمة وهمية هنا إذا لم يكن موجودًا في البيئة

    ##############################################
    #              إضافة قيمة وهمية لـ SITE_TITLE #
    ##############################################

    SITE_TITLE = os.getenv("SITE_TITLE", "My Bot")  # قيمة وهمية هنا إذا لم يكن موجودًا في البيئة
